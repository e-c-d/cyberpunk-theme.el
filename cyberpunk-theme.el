...
(let ((class '((class color) (min-colors 89)))
 ...
 (custom-theme-set-faces
   ...
   ;; rainbow-delimiters
   `(rainbow-delimiters-depth-1-face ((,class (:foreground ,cyberpunk-orange))))
   `(rainbow-delimiters-depth-2-face ((,class (:foreground ,cyberpunk-cyan))))
   `(rainbow-delimiters-depth-3-face ((,class (:foreground ,cyberpunk-yellow))))
   `(rainbow-delimiters-depth-4-face ((,class (:foreground ,cyberpunk-pink))))
   `(rainbow-delimiters-depth-5-face ((,class (:foreground ,cyberpunk-orange))))
   `(rainbow-delimiters-depth-6-face ((,class (:foreground ,cyberpunk-green))))
   `(rainbow-delimiters-depth-7-face ((,class (:foreground ,cyberpunk-cyan))))
   `(rainbow-delimiters-depth-8-face ((,class (:foreground ,cyberpunk-yellow))))
   `(rainbow-delimiters-depth-9-face ((,class (:foreground ,cyberpunk-pink))))
